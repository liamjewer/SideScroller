...
public class DangerBlock extends GameObject {
    Texture texture = Game.getInstance();
    private int type;

    public DangerBlock(float x, float y, int type, ObjectId id) {
        super(x, y, id);
        this.id = id;
        this.type = type;
    }
    ...
    public void render(Graphics g) {
        g.drawImage(texture.dangerBlock[type], (int)x, (int)y, null);
    }
